...
class DatasetProcessorNode(Node):
    def __init__(self):
        ...
        # Declare ROS 2 Parameters for dynamic folder paths
        # This allows overriding via command line
    ...
    def process_dataset(self):
        ...
        # Replace print() with ROS 2 logging
...
def main(args=None):
    ...
    # Since it's a batch script, destroy the node and shutdown after finishing
    node.destroy_node()
    rclpy.shutdown()
